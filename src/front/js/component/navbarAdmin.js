        ...
        <nav className="navbar  navbar-light bg-light mb-4">
			<div className="container ">
				...
				<div className="offcanvas offcanvas-start " data-bs-scroll="true" data-bs-backdrop="true" tabndex="-1" id="offcanvasScrolling1" aria-labelledby="offcanvasScrollingLabel">
                    ...
                    <Link className="btn btn-dark" to="/homeadmin" type="button"><i className="pe-none fas fa-home"></i> Home</Link>
							<Link className="btn btn-dark" to="/rateadmin" type="button"><i className="pe-none fas fa-sync"></i> Cambiar Tasa</Link>
							<Link className="btn btn-dark" to="/reportadmin" type="button"><i className="pe-none fas fa-download"></i> Reportes</Link>
							<Link className="btn btn-dark" to="/verificationadmin" type="button"><i className="pe-none fas fa-user-check"></i> Verificar Perfiles</Link>
                ...
                <button className="btn btn-outline-secondary" type="button" data-bs-toggle="offcanvas1" data-bs-target="#offcanvasRight1" aria-controls="offcanvasRight1"><i className="pe-none fas fa-user"></i></button>
            </div>
